...
-- This enables creators to showcase their best content with engagement metrics

-- Create table for creator portfolio videos
...
-- Add social account verification fields to creator_profiles
...
-- Add updated_at trigger for portfolio videos
...
-- RLS policies for portfolio videos
...
-- Add constraint: at least one social account must be verified for onboarded creators
-- This will be enforced at the application level during onboarding
