...
export async function updateSession(request) {
  ...
  if (user && (pathname === "/signin" || pathname === "/login")) {
    const url = request.nextUrl.clone();
    // Returning user hitting the sign-in page: hand off to the dashboard
    // router which picks brand vs creator based on which profile row exists.
