...
export async function completeOnboarding(payload) {
  ...
  // brand_stage / monthly_budget / content_needs / referral_source are no
  // longer collected during onboarding (it's 3 steps: name, industry, terms).
  // They stay optional on the profile, so nothing here may require them —
  // doing so made the final step impossible to pass.
