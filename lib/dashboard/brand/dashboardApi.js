...
// your attention" feed). The gigs table is readable by any authenticated
// user via the marketplace RLS policy, so gig-scoped queries here filter
// by brand_id explicitly.
