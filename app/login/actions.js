...
// The Supabase email template includes `&next={{ .RedirectTo }}` so the
// post-auth destination (e.g. /dashboard?role=creator) survives the round-trip
// in the URL itself — no cookie fallback needed.
