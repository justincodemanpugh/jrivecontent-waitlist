...
export default function AssignmentDetailView({ recipientId }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {isApproved ? (
        <div className="rounded-2xl bg-success-soft border border-success-line px-5 py-4 flex items-center gap-3">
        ...
        <div className="rounded-2xl bg-surface-sunken border border-line px-5 py-4 flex items-center gap-3">
          <Lock size={22} className="text-faint flex-shrink-0" />
          <div>
      ...
      {a.reviewStatus === "changes_requested" && (
        <div className="rounded-xl bg-warn-soft border border-warn-line px-4 py-3">
          <p className="text-sm font-medium text-warn flex items-center gap-2">
            <AlertCircle size={16} />
            The brand requested changes
          </p>
          {a.reviewFeedback && (
            <p className="mt-1 text-sm text-warn whitespace-pre-wrap">
              {a.reviewFeedback}
            </p>
          )}
  ...
  return (
    <div className="rounded-xl overflow-hidden border border-line bg-slate-900">
      {loadingUrl ? (
        ...
        <div className="aspect-video flex items-center justify-center text-faint text-sm">
  ...
  if (!canUpload && !hasSubmission) {
    return (
      <div className="rounded-2xl border border-dashed border-line bg-surface p-8 text-center">
        <span className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-surface-hover text-faint mb-3">
          <Lock size={20} />
        </span>
        ...
        <>
          ...
          >
            ...
            {uploading ? (
              ...
              <>
                <Upload size={24} className="mx-auto text-faint mb-2" />
